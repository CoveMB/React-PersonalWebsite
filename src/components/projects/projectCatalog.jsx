...
export const projectCatalog = [
  createProject({
    ...
    techStack: ["TypeScript", "Move", "React", "Sui", "Smart Contracts", "Deployment Tooling", "Artifacts", "Contract Calls", "Test Harness", "Developer Experience"],
  ...
  createProject({
    ...
    side: "right",
    techStack: ["TypeScript", "Node.js", "Svelte", "AWS Lambda", "DynamoDB", "SNS", "SQS", "Microservices", "Automation", "Monitoring", "Smart Contracts", "Blockchain"],
  ...
  createProject({
    ...
    isFeatured: true,
    primaryHref: "https://astro-light.on.fleek.co/",
    primaryLabel: "View live",
    side: "left",
    sourceHref: "https://github.com/CoveMB/solidity-DEFI-DAO",
    techStack: ["Solidity", "Ethereum", "Smart Contracts", "DeFi", "DAO", "Governance", "Staking", "Token Swap", "Teaching dApp", "Testnet"],
  ...
  createProject({
    ...
    side: "right",
    techStack: ["TypeScript", "Functional", "AWS Lambda", "DynamoDB", "SNS", "SQS", "EventBridge", "Microservices", "Event-Driven", "CI/CD", "CLI Tooling", "IDE Extension", "Scrum"],
  ...
  createProject({
    ...
    side: "left",
    techStack: ["TypeScript", "JavaScript", "Koa", "Express", "WebSockets", "Docker", "Terraform", "AWS", "CLI Tooling", "CI/CD", "Scrum", "Leadership"],
  ...
  createProject({
    ...
    side: "right",
    techStack: ["TypeScript", "Node.js", "Koa", "React", "GraphQL", "Machine Learning", "Architecture", "Product", "Docker", "Next AI"],
  ...
  createProject({
    ...
    primaryLabel: "Visit site",
    side: "left",
    techStack: ["Docker", "Kubernetes", "AWS", "Serverless", "Lambda", "CI/CD", "DevOps", "Agency Delivery", "Mentoring"],
  ...
  createProject({
    ...
    primaryHref: "https://react-rails-vizzmd-mvp.herokuapp.com",
    primaryLabel: "View project",
    side: "right",
    sourceHref: "https://github.com/CoveMB/Rails-React-VizzMD-App",
    techStack: ["Rails", "React", "MVP", "CTO", "Product", "CRM", "Healthcare", "Data Visualization", "Startup"],
  ...
  createProject({
    ...
    primaryLabel: "Visit site",
    side: "left",
    techStack: ["JavaScript", "Teaching", "Mentoring", "Full-Stack", "Curriculum", "Public Speaking"],
  ...
  createProject({
    ...
    primaryHref: "https://ruby-share-in-app.herokuapp.com/",
    primaryLabel: "View project",
    side: "right",
    sourceHref: "https://github.com/CoveMB/Rails-Share-in-App",
    techStack: ["Rails", "JavaScript", "WebSockets", "Real-Time Chat", "Team Project", "MVP", "Full-Stack"],
  ...
  createProject({
    ...
    mediaScale: 0.84,
    primaryHref: "https://github.com/CoveMB/Python-AirflowReportPipeline",
    primaryLabel: "Source",
    side: "left",
    sourceHref: "https://github.com/CoveMB/Python-AirflowReportPipeline",
    techStack: ["Python", "Airflow", "BigQuery", "Pandas", "APIs", "Docker", "Docker Compose", "Reporting"],
