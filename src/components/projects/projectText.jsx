...
export const cominityProjectText = (
  <p className="cardText ongoingText">
    ...
    to figure out the best solutions for our needs.
    <br />
...
export const airflowProjectText = (
  <p className="cardText ongoingText">
    ...
    <br />
    {' '}
    Working as a digital marketing specialist, I had a lot of reporting to do, especially because I was in charge of multiple clients. To make this reporting easier, I Learned
