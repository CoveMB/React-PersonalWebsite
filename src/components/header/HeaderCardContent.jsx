  ...
  return (
    <Fragment>
      ...
      <div className="headerCardText">
        ...
        <p className="cardListCompetence" style={{ marginLeft: "15px" }}><strong className="darkblueTitle"><img style={{ marginLeft: "10px" }} className="svgDone" src="/static/images/donesvg.svg" alt="svg done" /> Machine Learning Apprentice</strong> | Next AI</p>
